...
def anim(file_name, time_file_name, video_name):
  ...
  line_ani = animation.FuncAnimation(fig1, update_line, frames = M,
      interval=30, blit=True) #el interval ves cambiando como te guste, pero con 10 ya va bien
  line_ani.save(video_name)
  

anim("./../results/posiciones_DP.dat", "./../results/tiempo_DP.dat","./../plots/anim_DP.gif")